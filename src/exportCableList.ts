...
const exportColumns: ExportColumn[] = [
  ...
  { key: "srcComponent", header: "src_component" },
  { key: "srcPort", header: "src_port" },
  { key: "dstComponent", header: "dst_component" },
  ...
  return graph.edges
    ...
    .map((edge) => {
      ...
      return {
        ...
        srcComponent: source.srcComponent ?? source.srcBoard ?? source.srcDevice ?? "",
        srcPort: edge.sourcePortId ?? source.srcPort,
        dstComponent: source.dstComponent ?? source.dstBoard ?? source.dstDevice ?? "",
        dstPort: edge.targetPortId ?? source.dstPort,
